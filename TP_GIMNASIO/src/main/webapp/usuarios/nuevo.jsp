...
<body class="bg-info">
	...
	<div class="container mt-5">
		...
		<div class="container bg-white shadow-xl">
			<form class="needs-validation was-validated p-1" action="" method="post">
				<div class="row g-3">
					...
					<div class="col-md-4 col-lg-2">
						...
						<input type="date" class="form-control" name="fechaNacimiento" id="fechaNacimiento" placeholder="" required>
